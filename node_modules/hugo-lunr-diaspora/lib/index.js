...
function HugoLunr(input, output){
	...
	this.output = 'themes/jsimple/static/lunr.json';
...
HugoLunr.prototype.readFile = function(filePath){
	...
	if (ext == '.md' && meta.data.description){
		var plainText = removeMd(meta.data.description);
	} else {
		var plainText = striptags(meta.content.slice(0, 150));
	}

	var uri = '/posts/' + filePath.substring(0,filePath.lastIndexOf('.'));
